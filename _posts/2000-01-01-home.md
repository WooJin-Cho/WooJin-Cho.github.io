...
I am currently a Senior AI Researcher at [TelePIX](https://telepix.net/), serving as Technical Research Personnel under Korea’s alternative military service program. I received my M.S. in Artificial Intelligence from [Yonsei University](https://www.yonsei.ac.kr/en_sc/), where I was advised by [Prof. Noseong Park](https://sites.google.com/view/noseong) (now at [KAIST](https://www.kaist.ac.kr/en/)).

My research focuses on scientific machine learning (SciML) and AI for satellite applications. My interests include implicit neural representations, neural operators, and foundation models for physical systems, with a focus on high-dimensional scientific and satellite data. Broadly, I aim to develop numerically grounded and interpretable learning methods that connect numerical analysis with modern machine learning.

**I enjoy collaborating with researchers who share similar interests. If you are interested in my research or would like to collaborate, please feel free to contact me at [woojin.py@gmail.com](mailto:woojin.py@gmail.com).**
...
<div class="content-with-image">
  ...
  <p>
    ...
    <span style="font-family:'Times New Roman'; font-size: 18px; color: silver">
       J Park, <strong>W Cho<sup>&dagger;</sup></strong>
    </span><br>
...
<div class="content-with-image">
  <img src="../images/preprint_astra_benchmark.png" class="inline-image">
  <p>
    <span style="font-family:'Times New Roman'; font-size: 20px; color: black">
...
<div class="content-with-image">
  ...
  <p>
    ...
    <a href="https://arxiv.org/pdf/2608.06959" target="_blank">
      <i class="fa-regular fa-file-lines"></i> Paper
    </a>
  </p>
</div>
...
<div class="content-with-image">
  ...
  <p>
    ...
    <a href="https://arxiv.org/pdf/2608.06942" target="_blank">
      <i class="fa-regular fa-file-lines"></i> Paper
    </a> 
  </p>
</div>
...
<div class="content-with-image">
  <img src="../images/preprint_elmzip2.png" class="inline-image">
  <p>
    <span style="font-family:'Times New Roman'; font-size: 20px; color: black">
        On-Orbit Demonstration of Backpropagation-Free Neural Compression for Earth Observation
    </span><br>
    <span style="font-family:'Times New Roman'; font-size: 18px; color: silver">
        <strong>W Cho</strong>, J Park, S Sim, D Kwon
    </span><br>
    <span style="font-family:'Times New Roman'; font-size: 20px; color: gray">(Under review)</span><br/>
  </p>
</div>
...
<div class="content-with-image">
  ...
  <p>
    ...
    <a href="https://openreview.net/pdf?id=dIO3JLoy19" target="_blank">
      <i class="fa-regular fa-file-lines"></i> Paper
    </a>
  </p>
</div>
...
<div class="content-with-image">
  ...
  <p>
    ...
    <span style="font-family:'Times New Roman'; font-size: 20px; color: black"><strong>CVPR Workshop 2026</strong></span><br/>
    <a href="https://openreview.net/pdf/216a842d719aa638095b892111a2a990b6d986f8.pdf" target="_blank">
      <i class="fa-regular fa-file-lines"></i> Paper
    </a>
  </p>
</div>
...
#### [AGU Fall Meeting 2025](https://www.agu.org/annual-meeting-2025)
* [Sequential Dynamics-aware Foundation Model for Vision-based Space Navigation](https://ui.adsabs.harvard.edu/abs/2025AGUFMIN31A8047C/abstract) (Lead author)
...
* AI for Science: Learning Scientific Signals via Implicit Neural Representations (hosted by [Solver X](https://www.solverx.ai/))
* Physics-informed Machine Learning and the Road to Scientific Foundation Models (hosted by [ETRI](https://www.etri.re.kr/eng/main/main.etri))
